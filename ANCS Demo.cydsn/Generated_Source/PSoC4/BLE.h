...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MIN      (0x0010u)
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MAX      (0x0010u)
    #define CYBLE_GAPC_CONNECTION_SLAVE_LATENCY     (0x0000u)
    #define CYBLE_GAPC_CONNECTION_TIME_OUT          (0x012Cu)
...
#define CYBLE_PAIRING_METHOD                         (0x01u)
...
#define CYBLE_ADV_PKT_INDEX_SERVICE_SOLICITATION_128   (0x09u)
